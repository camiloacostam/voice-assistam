...
export default function MicrophoneIcon({
  ...
  fill = "#000",
  ...restProps
}: React.SVGProps<SVGElement> & IProps) {
  return (
    <svg
      version="1.0"
      id="Layer_1"
    ...
    >
      <g>
        <path
          fill={fill}
          d="M32,48c7.732,0,14-6.268,14-14V14c0-7.732-6.268-14-14-14S18,6.268,18,14v20C18,41.732,24.268,48,32,48z
       ...
       h-5c-0.553,0-1,0.447-1,1s0.447,1,1,1h5v3c0,6.627-5.373,12-12,12s-12-5.373-12-12V31z"
        ...
        <path
          fill={fill}
          d="M51,31.002c-1.657,0-2.999,1.342-3,2.998c-0.001,8.838-7.163,15.999-16,15.999S16.001,42.838,16,34
